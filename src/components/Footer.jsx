            ...
            <div className="container py-1">
                <div className="row">
                    <div className="col-md-6 col-12 my-auto">
                        <small>Copyright &copy; Nakshatra Meena</small>
                    </div>
                    <div className="col-md-6 col-12">
                        <div className="d-flex float-right">
                            <a href="https://www.facebook.com/nakshatrameena.1">
                                <FaFacebookSquare className="connect text-dark" /></a>
                            <a href="https://www.linkedin.com/in/nakshatrameena/">
                                <FaLinkedin className="connect text-dark" /></a>
                            <a href="https://www.instagram.com/meenanakshatra/">
